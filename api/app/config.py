...
MONERO_WALLET_RPC_LOCK_TIMEOUT_SECONDS = float(
    os.getenv("MONERO_WALLET_RPC_LOCK_TIMEOUT_SECONDS", "15")
)
MONERO_WALLET_READY_TIMEOUT_SECONDS = float(
    os.getenv("MONERO_WALLET_READY_TIMEOUT_SECONDS", "60")
)
MONERO_WALLET_READY_POLL_INTERVAL_SECONDS = float(
    os.getenv("MONERO_WALLET_READY_POLL_INTERVAL_SECONDS", "1")
)
